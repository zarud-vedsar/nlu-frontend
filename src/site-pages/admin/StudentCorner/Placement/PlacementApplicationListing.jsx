...
const PlacementApplicationListing = () => {
          ...
          <div className="container-fluid">
            ...
            <div className="card bg-transparent mb-2">
              <div className="card-header id-pc-divices-header px-0 id-mobile-divice-d-block">
                <h5 className="card-title h6_new">Placement Application List</h5>
                        ...
                        body={(rowData) => (
                          <div className="d-flex justify-content-around">
                            <div
                              onClick={() =>
                                navigate(
                                  `/admin/placement-application/${rowData?.id}`
                                )
                              }
...
export default PlacementApplicationListing;
