            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 rightpart">
              <div className="section-title-wrapper">
                <div className="section-title">
                  <h3 className="heading-primary3 butler-regular source-font">Emblem and Motto</h3>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-sm-12">
                    ...
                    <p className="heading-para gorditas-regular">
                      ...
                      <p className="heading-para gorditas-regular source-font">यान्ति न्यायप्रवृत्तस्य तिर्यङ्कोऽपि सहायताम् । अपन्थानं तु गच्छन्तं सोदरोऽपि विमुञ्चति ॥</p>
                      <p className="heading-para gorditas-regular source-font">
                      ...
                      <h6 className="heading-primary2 source-font" style={{ fontSize: '18px' }}>Laurel Leaves</h6>
                      <p className="heading-para gorditas-regular source-font">
                      ...
                      <h6 className="heading-primary2 source-font" style={{ fontSize: '18px' }}>Balance of Justice on a Pen</h6>
                      <p className="heading-para gorditas-regular source-font">
                      ...
                      <h6 className="heading-primary2 source-font" style={{ fontSize: '18px' }}>Confluence of Ganga and Yamuna Rivers:</h6>
                      <p className="heading-para gorditas-regular source-font">
                      ...
                      <p className="heading-para gorditas-regular source-font">In this symbiotic relationship, Knowledge serves as the fertile soil from which legal principles grow, facilitating informed decision-making. The combination ensures that decisions are not only wise but also grounded in established rules, enhancing their legitimacy. The confluence fosters adaptability, allowing the legal education to navigate changing landscapes and stay resilient in the face of evolving challenges. Much like the diverse ecosystem nurtured by converging rivers, the integration of knowledge and Justice establishes a rich educational and legal environment.</p>
                    </p>
                  </div>
                </div>
