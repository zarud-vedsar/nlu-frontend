                        ...
                        <div className="course-card-body">
                          {
                            id == 1 && (
                              <>
                                <h2 className='heading-primary2 source-font'>Overview of B.A. LL.B. (Hons.)</h2>
                                ...
                                <h2 className='heading-primary2 source-font'>Why Choose B.A. LL.B. (Hons.) at Dr. Rajendra Prasad National Law University?</h2>
                                ...
                                <h2 className='heading-primary2 source-font'>Course Structure and Curriculum</h2>
                          ...
                          }
                          {
                            id == 2 && (
                              <>
                                <h2 className='heading-primary2 source-font'>Overview of Ph.D. (Law) Program</h2>
                                <p className='heading-para'>
                                ...
                                <h2 className='heading-primary2 source-font'>Why Pursue Ph.D. (Law) at Dr. Rajendra Prasad National Law University?</h2>
                                ...
                                <h2 className='heading-primary2 source-font'>Specializations Offered</h2>
                                ...
                                <h2 className='heading-primary2 source-font'><strong>Program Structure and Duration</strong> </h2>
                                ...
                                <h2 className='heading-primary2 source-font'>Research Opportunities and Facilities</h2>
                                ...
                                <h2 className='heading-primary2 source-font'>Career Prospects After Ph.D. (Law)</h2>
                                ...
                                <h2 className='heading-primary2 source-font'> Why Choose Dr. Rajendra Prasad National Law University?</h2>
