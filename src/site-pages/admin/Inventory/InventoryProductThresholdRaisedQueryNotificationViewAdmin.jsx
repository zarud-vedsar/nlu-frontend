...
function Registration() {
  ...
  useEffect(() => {
    if (RolePermission && RolePermission.length > 0) {
      if (!hasPermission("Restock Notification List", "view")) {
        navigate("/forbidden");
      }
    }
  ...
  const changeStatusOfStock = async () => {
    ...
    try {
      ...
      const response = await dataFetchingPost(
        `${NODE_API_URL}/api/inventory/product/threshold-product-change-status`,
            ...
            <div className="card bg-transparent mb-2">
              <div className="card-header id-pc-divices-header px-0 id-mobile-divice-d-block">
                ...
                <div className="ml-auto id-mobile-go-back">
                  ...
                  {hasPermission("Restock Notification List","list") && (
                  <Link
              ...
              <div className="card-body pt-3">
                <div className="row">
                  ...
                  <div className="col-md-7 col-7">
                    {hasPermission("Restock Notification List","Update Restock Notification Status") && (
                    <button
                      onClick={changeStatusOfStock}
                      type="button"
                ...
                <p className="mt-2">
                  <strong>Remark:</strong> {productThresholdData[0]?.remark}
                </p>
              </div>
            </div>
          </div>
