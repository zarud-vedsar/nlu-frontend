...
const PlacementApplicationViewPage = () => {
  const { id } = useParams();
  ...
  const loadConversationHistory = async () => {
    ...
    try {
      const bformData = new FormData();
      bformData.append("data", "placementmailreply");
      ...
      setConversation([]);
      console.error("Error fetching placement mail data:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const getCandidateDetail = async () => {
    ...
    try {
      const bformData = new FormData();
      bformData.append("data", "load_placement_application");
      bformData.append("appid", id);
      bformData.append("loguserid", secureLocalStorage.getItem("login_id"));
      bformData.append("login_type", secureLocalStorage.getItem("loginType"));
    ...
    <div className="page-container">
      ...
      <div className="">
              <nav className="breadcrumb breadcrumb-dash">
                ...
                <span className="breadcrumb-item active">Placement Applications</span>
              </nav>
            </div>
        ...
        <div className="row">
          ...
          <div className="col-md-12 col-sm-12 col-12 col-lg-12">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title h6_new">Placement Detail</h5>
              </div>
              <div className="card-body">
...
export default PlacementApplicationViewPage;
