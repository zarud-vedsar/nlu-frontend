...
function SemesterAdd() {
  ...
  useEffect(() => {
    let duration = courseListing?.find(
      (course) => course?.id === formData?.courseid
    )?.duration;

    setYearListing(duration ? duration.split(",") : []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${NODE_API_URL}/api/semester/register`,
        formData
      );
      if (
                        ...
                        <div className="col-md-12 form-group">
                          ...
                          <Select
                            ...
                            value={
                              courseListing.find(
                                (page) =>
                                  page.id === parseInt(formData.courseid)
                              )
                                ? {
                        ...
                        <div className="col-md-12 form-group">
                          ...
                          <Select
                            ...
                            onChange={(selectedOption) => {
                              setFormData({
                                ...formData,
                                courseyearid: selectedOption.value,
                              });
                            }}
                            value={
                              yearListing.find(
                                (item) => item == formData.courseyearid
                              )
                                ? {
                        ...
                        <div className="col-md-12 form-group">
                          ...
                          <Select
                            ...
                            onChange={(selectedOption) => {
                              setFormData({
                                ...formData,
                                semtitle: selectedOption.value,
                              });
                            }}
                            value={
                              semesterList.find(
                                (item) => item === formData.semtitle
                              )
                                ? {
