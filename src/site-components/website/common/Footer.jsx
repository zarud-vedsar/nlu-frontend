        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-3 hidden-sm">
              <div className="single-footer-widget">
                <h3 className="heading-primary3 butler-regular mb-3" style={{ color: "#7D1944" }}>Quick Links</h3>
            ...
            <div className="col-md-3 col-sm-4">
              <div className="single-footer-widget">
                <h3 className="heading-primary3 butler-regular mb-3" style={{ color: "#7D1944" }}>Policies and Terms</h3>
                <ul className="footer-list">
                  <li>
            ...
            <div className="col-md-3 col-sm-4">
              <div className="single-footer-widget">
                <h3 className="heading-primary3 butler-regular mb-3" style={{ color: "#7D1944" }}>Contact Information</h3>
                <span>
                ...
                <span className="footer-para">
                  ...
                  {contactData.c_add ? validator.unescape(contactData.c_add) : ''}
                </span>
                <span className="visitor-counting">
                  Visitor:{" "}
                  {
                    visitorData?.data && visitorData.data.toString().split('').map((data, index) => (
                      <span className="id-visitor-data" key={index}>{data}</span>
                    ))
                  }
                </span>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 col-sm-6" style={{ textAlign: "center" }}>
              <span>
                &copy; {currentYear} {brandData.business_bottom}. All rights reserved.
              </span>
            </div>
            <div className="col-md-6 col-sm-6" style={{ textAlign: "center" }}>
