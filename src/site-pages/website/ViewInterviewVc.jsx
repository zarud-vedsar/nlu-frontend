                    ...
                    <div className="row">
                        <div className="col-md-10 mx-auto">
                            <h3 className="source-font">
                                Q1. What is your immediate priority as the first VC of NLU Prayagraj?
                            </h3>
                        ...
                        <div className="col-md-10 mx-auto">
                            <h3 className="source-font">
                                Q2. How does your institution plan to stand out among other NLUs?
                            </h3>
                            <p className="source-font text-justify">
                                Firstly, NLU’s location in Prayagraj is quite distinctive. Prayagraj, often referred to as the judicial capital of the state, stands as a guiding light for legal education, scholarly pursuit and ethical leadership. Prayagraj has been known for her academic legacy and has produced erudite legal scholars of national and international repute. NLU’s proximity to the High Court of Allahabad – India’s largest and a powerful high court – makes it possible for leading members of the bar and bench to make a significant contribution to the growth of the NLU.
                            </p>
                            <p className="source-font text-justify">
                            ...
                            <p className="source-font text-justify">
                                Furthermore, we intend to empower our students to inculcate the idea of start-ups by establishing an incubation centre at the NLU, where young minds may come up with legal apps, legal products, legal consultancy etc. Most importantly, a robust mechanism for campus recruitment of students with top-tier law firms and multinational companies (MNCs) is our top agenda.
                            </p>
                            <p className="source-font text-justify">
                        ...
                        <div className="col-md-10 mx-auto">
                            ...
                            <p className="source-font text-justify">
                                We are offering admission for the first batch of the integrated five-year BA-LLB degree programme for academic year 2024-25 and we are relying on CLAT scores for admission.
                            </p>
                        </div>
                        <div className="col-md-10 mx-auto">
                            <h3 className="source-font">
                                Q4. Will research be a priority?
                            </h3>
                            <p className="source-font text-justify">
                            ...
                            <p className="source-font text-justify">
                                International and comparative law studies further expand students’ horizons, fostering a global outlook essential in today’s interconnected world. Embracing legal technology, policy research, empirical studies, and tailoring research to address local legal issues will be our primary concern. This research agenda encompassing traditional legal education and forward-thinking subjects will establish a dynamic foundation for our law university.
                            </p>
                        </div>
                        <div className="col-md-10 mx-auto">
                            <h3 className="source-font">
                                Q5. Technology is becoming more and more important in the legal space. Is this something you are planning to incorporate into the curriculum?
                            </h3>
                            <p className="source-font text-justify">
                                Our curriculum and research will be designed considering the dynamic relationship between law and technology. Our curriculum will cover foundational legal principles vis-a-vis technology, including intellectual property, cyber law, privacy rights, data security etc. It will also explore emerging legal issues in AI, blockchain, digital rights and the ethical implications of technology in legal practice.
                            </p>
                            <p className="source-font text-justify">
                        ...
                        <div className="col-md-10 mx-auto">
                            <h3 className="source-font">
                                Q6. Are you planning to launch any new-age courses?
                            </h3>
                            <p className="source-font text-justify">
                                Along with traditional courses, we will offer courses that cater to the evolving legal landscape. Besides technology law, other courses include environmental law; entertainment and media law covering intellectual property rights in the industry; healthcare and bioethics law; international human rights law focusing on global rights issues; corporate compliance, delving into ethics and governance; sports law; and alternative dispute resolution covering mediation and arbitration.
                            </p>
                            <p className="source-font text-justify">
...
export default ViewInterviewVc