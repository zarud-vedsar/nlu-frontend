    ...
    try {
      ...
      if (response.data.statusCode === 200) {
        setFormData((prev) => ({
          ...
          date: validator.unescape(response.data?.data[0].date || ""),
          ...
          <div className="page-header mb-0">
            <div className="header-sub-title">
              ...
              <a href="/admin/home" className="breadcrumb-item">
                ...
                <span className="breadcrumb-item active">{dbId ? "Update Calendar" : "Add New Calendar"}</span>
              </nav>
            </div>
          </div>
              ...
              <div className="card-body">
                <div className="row mb-4">
                  ...
                  <div className='col-md-12'>
                    ...
                    <label className='font-weight-semibold'>Content  <span className="text-danger">*</span></label>
                    <JoditEditor
