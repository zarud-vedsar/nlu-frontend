...
function CourseDetail({ sid, update }) {
  // Initial form state
  const initialForm = {
    id: "",
    studentId: "",
  ...
  useEffect(() => {
    const tempSelectedSemester = semesterListing.find(
      (item) => item.id === parseInt(formData.semesterid)
    );
    if (tempSelectedSemester) {
      setSelectedSemester(tempSelectedSemester.semtitle.toLowerCase());
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${NODE_API_URL}/api/course-selection/adminEditApplicationDetail`,
        formData
      );
        ...
        <div className="card-body">
          <div className="row">
            <div className="col-md-12 mt-2 mb-3">
              <h6 className="custom">
                <span className="custo-head">Course Selection</span>
              </h6>
            </div>
            <div className="card-body">
                ...
                <div className="row">
                  <div className="col-md-12 form-group">
                    ...
                    <Select
                      ...
                      onChange={(selectedOption) => {
                        ...
                        setSelectedCourse(selectedOption.label.toLowerCase());
                        resetSemester();
                  ...
                  <div className="col-md-12 form-group">
                    ...
                    <Select
                      ...
                      onChange={(selectedOption) => {
                        ...
                        setSelectedSemester(selectedOption.label.toLowerCase());
                        resetGroup();
                      }}
                      value={
                  ...
                  {selectedCourse == "B.A. LL.B. (Hons.)".toLowerCase() &&
                    ((semesters.includes(selectedSemester) && (
                      ...
                      (selectedSemester === "semester 8".toLowerCase() && (
                        <BallbSemesterEight />
                      )) ||
                      (selectedSemester === "semester 9".toLowerCase() && (
                        <BallbSemesterNine />
                      )) ||
                      (selectedSemester === "semester 10".toLowerCase() && (
                        <BallbSemesterTen />
                      )))}
                  {selectedCourse == "LL.M.".toLowerCase() &&
                    ((selectedSemester === "semester 1".toLowerCase() && (
                      ...
                      (selectedSemester === "semester 2".toLowerCase() && (
                        <LlmSemesterTwo />
                      )))}
