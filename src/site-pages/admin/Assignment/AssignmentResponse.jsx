...
function AssignmentResponse() {
  ...
  const [applicationList, setAssignmentResponseList] = useState([]);
 ...
 */
  ...
  const fetchAllAssignmentusingResponsePhp = async () => {
    setIsFetching(true);
    ...
    try {
      ...
      bformData.append("data", "assignment_response_load");
      ...
      if (response.data?.status === 200 && response.data.data.length > 0) {
        ...
        setAssignmentResponseList(response?.data?.data);
      } else {
                ...
                <div className="row">
                  ...
                  <div className="col-12 d-flex  mt-2">
                    <button
                      ...
                      type="submit"
                      onClick={fetchAllAssignmentusingResponsePhp}
                    >
                      Search{" "}
                      {isFetching && (
                        <>
                      ...
                      <Column
                        ...
                        body={(rowData) => (
                          <div className="d-flex justify-content-center">
                            <Link
                              to={`/admin/assignment-response-view/${rowData.id}`}
