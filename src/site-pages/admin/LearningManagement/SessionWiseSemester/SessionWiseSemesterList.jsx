...
import { capitalizeFirstLetter, dataFetchingPost, formatDate, goBack } from '../../../../site-components/Helper/HelperFunction';
...
function SessionWiseSemesterList() {
    ...
    useEffect(()=>{        fetchSemesterListing();
    },[selectedSesssion])
    ...
    const updateDataFetch = async (dbId) => {
        ...
        navigate(`/admin/learning-management/session-wise-semester/edit/${dbId}`, { replace: false });
    }
                        ...
                        <div className="page-header mb-0">
                            <div className="header-sub-title">
                                <nav className="breadcrumb breadcrumb-dash">
                                    ...
                                    <span className="breadcrumb-item active">Session Wise Semester List</span>
                                </nav>
                            </div>
                        </div>
                        <div className="card bg-transparent mb-2">
                            <div className="card-header d-flex justify-content-between align-items-center px-0">
                                <h5 className="card-title h6_new">Session Wise Semester  List</h5>
                                <div className="ml-auto">
                                    ...
                                    <Link
                                        to={'/admin/learning-management/session-wise-semester/add-new/'}
