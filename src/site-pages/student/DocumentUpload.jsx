...
import { PHP_API_URL, FILE_API_URL, NODE_API_URL } from '../../site-components/Helper/Constant';
function DocumentUpload() {
    ...
    const handleFileChange = (e) => {
        ...
        if (file.type === "application/pdf") {
            ...
            if (id === "character_certificate") {
                ...
                setFormData((formData) => ({ ...formData, character_certificate: file }));
            }
    ...
    const handleSubmit = async (e) => {
        ...
        sendFormData.append('character_certificate', formData.character_certificate);
            ...
            getDocument(level?.id).then((res) => {
                if (res.length > 0) {
                    setFormData((prev) => ({
                        ...
                        hcharacter_certificate: res[0].character_certificate,
                        caste_certificate: res[0].caste_certificate,
                        hcaste_certificate: res[0].caste_certificate,
                    }));
                    if (res[0].dtc) {
                        setShowPreview(true);
                    }
                            ...
                            <div className="col-md-7 col-lg-7 mx-auto">
                                <div className="card bg-transparent">
                                    <div className="card-header px-0 mb-0 d-flex justify-content-between align-items-center">
                                        <div><Link to="/student/qualification" className="btn btn-primary"><i className="fas fa-arrow-left"></i> Previous</Link></div>
                                        <div>
                                            {showPreview && (
                                                <Link to="/student/preview" className="btn btn-secondary ml-2">Preview <i className="fas fa-arrow-right"></i></Link>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <div className="row">
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <p className="text-danger">Please ensure the following for document uploads:</p>
                                                    <ul className="list-group">
                                                        <li className='item text-danger'>Transfer Certificate (TC), Character Certificate, and Caste Certificate (if available) should each be a maximum of 2 MB.</li>
                                                    </ul>
                                                </div>
                                                <div className="col-md-10 col-lg-10 col-sm-9 col-9 form-group mb-3">
                                                    <label>Transfer Certificate (TC) <strong className="text-danger">*</strong></label>
                                                    <input
                                                        type="file"
                                                        id="dtc"
                                                        name='dtc'
                                                    ...
                                                    />
                                                    <p className="text-danger mb-0">{errors.field === 'dtc' && errors.msg}</p>
                                                </div>
                                                <div className="col-md-2 col-lg-2 col-sm-3 col-3 form-group mb-3 d-flex justify-content-start align-items-center">

                                                    {previewPdfTc && (
                                                        <Link target='_blank' to={previewPdfTc}><button type="button" className="btn btn-secondary text-white mt-4"> <i className="fas fa-eye text-white"></i> </button></Link>
                                                    )}
                                                </div>
                                                <div className="col-md-10 col-lg-10 col-sm-9 col-9 form-group mb-3">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={handleFileChange}
                                                    />
                                                    <p className="text-danger mb-0">{errors.field === 'character_certificate' && errors.msg}</p>
                                                </div>
                                                <div className="col-md-2 col-lg-2 col-sm-3 col-3 form-group mb-3 d-flex justify-content-start align-items-center">

                                                    {previewPdfCharacter && (
                                                        <Link target='_blank' to={previewPdfCharacter}><button type="button" className="btn btn-secondary text-white mt-4"> <i className="fas fa-eye text-white"></i> </button></Link>
                                                    )}
                                                </div>
                                                <div className="col-md-10 col-lg-10 col-sm-9 col-9 form-group mb-3">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={handleFileChange}
                                                    />
                                                    <p className="text-danger mb-0">{errors.field === 'caste_certificate' && errors.msg}</p>
                                                </div>
                                                <div className="col-md-2 col-lg-2 col-sm-3 col-3 form-group mb-3 d-flex justify-content-start align-items-center">

                                                    {previewPdfCast && (
                                                        <Link target='_blank' to={previewPdfCast}><button type="button" className="btn btn-secondary text-white mt-4"> <i className="fas fa-eye text-white"></i> </button></Link>
                                                    )}
                                                </div>
