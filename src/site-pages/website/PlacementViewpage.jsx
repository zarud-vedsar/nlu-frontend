...
const PlacementViewpage = () => {
  ...
  const getInternshipDetail = async () => {
    try {
      ...
      formData.append("data", "get_placement_by_id");
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="breadcrumb-text">
                <h1 className="heading-primary2 butler-regular text-white text-center">Placement Details</h1>
                <div className="breadcrumb-bar">
                  <ul className="breadcrumb text-center">
                    <li><Link to="/">Home</Link></li> <FaAngleRight />
                    <li>Student Corner</li> <FaAngleRight />
                    <li><Link to='/placement'>Placement</Link></li> <FaAngleRight />
            ...
            <div className="col-12 col-sm-12 col-md-7 col-lg-7 mx-auto">
              <div className="card border-0">
                <div className="card-body">
                  <h3 className="heading-primary2 butler-regular text-primary">{detail?.job_title}</h3>
