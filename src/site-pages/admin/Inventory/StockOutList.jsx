...
function ProductList() {
  ...
  useEffect(() => {
    if (RolePermission && RolePermission.length > 0) {
      if (!hasPermission("Stock Out History", "list")) {
        navigate("/forbidden");
      }
    }
    ...
    try {
      const response = await dataFetchingPost(
        `${NODE_API_URL}/api/inventory/stock/out/list`,
        {
          ...
          stockOutDateStart: formData.stockOutDateStart,
          stockOutDateEnd: formData.stockOutDateEnd,
        }
      );
      if (response?.statusCode === 200 && response.data.length > 0) {
          ...
          <div className="container">
            <div className="page-header mb-0">
              <div className="header-sub-title">
                <nav className="breadcrumb breadcrumb-dash">
                  ...
                  <span className="breadcrumb-item active">Stock Out</span>
                </nav>
              </div>
            </div>
            <div className="card border-0 bg-transparent mb-2">
              <div className="card-header border-0 bg-transparent id-pc-divices-header px-0 id-mobile-divice-d-block">
                <h5 className="card-title h6_new pt-0">Stock Out History</h5>
                <div className="ml-auto id-mobile-go-back">
                  ...
                  {hasPermission("Stock Out History","create") && (
                    ...
                    <Column
                      ...
                      body={(rowData) => (
                        <div className="d-flex">
                            {hasPermission("Stock Out History","update") && (
                          <Link
                            to={`/admin/inventory/product/add-stockout/${rowData.id}`}
        ...
        <Offcanvas.Body>
          <form onSubmit={handleFilter}>
            <div className="row">
              ...
              <div className="col-md-12 col-lg-12 form-group">
                <label className="font-weight-semibold">Staff</label>
                <Select
                  ...
                  value={
                    facultyList.find((item) => item.id === formData.facultyId)
                      ? {
                          ...
                          label: `${
                            facultyList.find(
                              (item) => item.id === formData.facultyId
                            )?.facultyName
                          } (${
                            facultyList.find(
                              (item) => item.id === formData.facultyId
              ...
              <FormField
                ...
                id="stockOutDateStart"
                type="date"
                value={formData.stockOutDateStart}
                onChange={handleChange}
              ...
              <FormField
                ...
                id="stockOutDateEnd"
                type="date"
                value={formData.stockOutDateEnd}
                onChange={handleChange}
                column="col-md-6 col-lg-6"
              />
