            ...
            <div className="faculty-slider-container">
              ...
              {Quotes.map((quote, index) => (
                <div className="id-quotes-wrapper" key={index}>
                  <p className="id-quote source-font">
                    {quote.quotes}
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum sit tempora itaque asperiores, quod aliquam nisi nesciunt quibusdam consequatur. Adipisci.
                  </p>
                  <p className="id-quote-by-name source-font">
                    {quote.name}
                  </p>
                </div>
              ))}
