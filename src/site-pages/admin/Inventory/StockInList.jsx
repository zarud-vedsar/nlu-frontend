...
function ProductList() {
    ...
    const fetchList = async () => {
        ...
        setIsSubmit(true);
        try {
            const response = await dataFetchingPost(`${NODE_API_URL}/api/inventory/stock/in/list`,
                {
                            ...
                            <div className="card-body">
                                ...
                                <div className={`table-responsive ${isFetching ? 'form' : ''}`}>
                                    ...
                                    >
                                        ...
                                        <Column body={(row) => row.stockInDate ? formatDate(row.stockInDate) : row.stockInDate} header="Stock In Date" sortable />
                                        <Column body={(row) => row.created_at ? formatDate(row.created_at) : row.created_at} header="Created At" sortable />
                                        <Column
                                            header="Action"
                                            body={(rowData) => (
                                                <div className="d-flex">
                                                    <Link to={`/admin/inventory/product/add-stock/${rowData.id}`} className="avatar avatar-icon avatar-md avatar-orange">
