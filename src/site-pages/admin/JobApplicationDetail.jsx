...
const JobApplicationDetail = () => {
  ...
  const loadConversationHistory = async () => {
    ...
    try {
      const bformData = new FormData();
      bformData.append("data", "jobmailreply");
      ...
      <div className="">
        ...
        <div className="card bg-transparent mb-2">
            <div className="card-header d-flex justify-content-between align-items-center px-0">
              <h5 className="card-title h6_new">Job Application Detail</h5>
                      ...
                      <div className="d-md-flex align-items-start">
                        ...
                        <div className="text-center text-sm-left m-v-15 p-l-30">
                          <h6 className="m-b-5 h6_new mr-2 font-15">
                            {`${customerDetail?.cat_title} ${customerDetail?.name}` ||
                              "No name"}
                          </h6>
        ...
        <div className="row">
          ...
          <div className="col-md-12 col-sm-12 col-12 col-lg-12">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title h6_new">Job Details</h5>
              </div>
              <div className="card-body">
