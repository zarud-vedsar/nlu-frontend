...
import { getEducation } from "../../../../site-components/student/GetData"; 
import "../../../../site-components/student/assets/css/custom.css"; 
...
function EducationDetail({sid , trigger }) {
  ...
  const handleSubmit = async (e) => {
    ...
    sendFormData.append("data", "adminupdateeducationaldetails");
  ...
  const getStudentSelectedCourse = async () => {
    try {
      ...
      if (response?.data?.statusCode === 200) {
        ...
        getEducationDetail(response?.data?.data[0]?.id)
      }
    } catch (error) {}
  };
