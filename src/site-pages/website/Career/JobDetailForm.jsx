...
const JobDetailForm = () => {
  const initialization = {
    ...
    "app-phone": "",
    "app-alternate-phone": "",
    "app-law-convicted": "no",
    "app-any-interviewed": "no",
    "app-worked-before": "no",
    "app-any-employee": "no",
    "app-photo": "",
    "app-resume": "",
    "app-cover-letter": "",
  ...
  useEffect(() => {
    ...
    if (formData) {
      formData["data"] = "jobfinalapp";
      formData["name"] = localStorage.getItem("name") || "";
      formData["email"] = localStorage.getItem("email") || "";
      formData["jobid"] = localStorage.getItem("jobid") || "";
    }
  ...
  const validateForm = () => {
    for (let key in formData) {
      if (
        ...
        key !== "app-lname" && key !== "app-middle-name"
      ) {
        setErrorKey(key);
        setErrorMessage(
              ...
              <div className="card border-0 bg-white" style={{ width: '100%', maxWidth: '100%' }}>
                <div className="card-body">
                  <form onSubmit={handleSubmit}>
                    <h2 className="heading-primary2 butler-regular"> Contact Information </h2>
                    <p className="heading-para gorditas-regular mb-2">Please provide contact details accurately</p>
                    <p className="heading-para gorditas-regular text-primary">
                      Ensure your first name and last name matches the name on your
                      Aadhaar card for verification purposes
                    </p>
                    {/* Title Field */}
                    <div className="form-group">
                      ...
                      >
                        ...
                        <option value="Mr." selected={formData['app-title'] == 'Mr.'}>Mr.</option>
                        <option value="Mrs." selected={formData['app-title'] == 'Mrs.'}>Mrs.</option>
                        <option value="Miss" selected={formData['app-title'] == 'Miss'}>Miss</option>
                        <option value="Doctor" selected={formData['app-title'] == 'Doctor'}>Doctor</option>
                      </select>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className="form-control"
                        value={formData["app-middle-name"]}
                        onChange={handleChange}
                      />
                    </div>
                    ...
                    <div className="form-group">
                      <label>
                        Alternative Phone Number<span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="">
                      <h2 className="heading-primary2 butler-regular">Application Questions</h2>
                      <p className="heading-para gorditas-regular">Please Answer the following questions</p>
                    </div>
                    {/* Select Fields (Convicted, Interviewed, Worked Before, Employee) */}
                    <div className="form-group">
                      <label>
                        Have you been convicted by the law in any court of India or
                        Outside <span className="text-danger">*</span>
                      </label>
                      <select
                        name="app-law-convicted"
                        className="form-control"
                        value={formData["app-law-convicted"]}
                        onChange={handleChange}
                      >
                    ...
                    <div className="form-group">
                      <label>
                        Have you been interviewed by us or any of our group companies in
                        the past <span className="text-danger">*</span>
                      </label>
                      <select
                        name="app-any-interviewed"
                        className="form-control"
                        value={formData["app-any-interviewed"]}
                        onChange={handleChange}
                      >
                        <option value="yes">Yes</option>
                        <option value="no">No</option>
                    ...
                    <div className="form-group">
                      <label>
                        Have you worked with Dr. Rajendra Prasad
                        National Law University (RPNLU){" "}
                        <span className="text-danger">*</span>
                      </label>
                      <select
                        name="app-worked-before"
                        className="form-control"
                        value={formData["app-worked-before"]}
                        onChange={handleChange}
                      >
                        <option value="yes">Yes</option>
                        <option value="no">No</option>
                    ...
                    <div className="form-group">
                      <label>
                        Are you related to any employee of Dr. Rajendra Prasad
                        National Law University (RPNLU){" "}
                        <span className="text-danger">*</span>
                      </label>
                      <select
                        name="app-any-employee"
                        className="form-control"
                        value={formData["app-any-employee"]}
                        onChange={handleChange}
                      >
                        <option value="yes">Yes</option>
                        <option value="no">No</option>
                    ...
                    <div className="">
                      <h2 className="heading-primary2 butler-regular">Documents</h2>
                      <p className="heading-para gorditas-regular mb-2">Please add additional documents</p>
                      <p className="heading-para gorditas-regular text-primary mb-2">Note that cover letter is optional </p>
                      <p className="heading-para gorditas-regular text-primary">Only PDF files upto 2MB are allowed </p>
                    </div>
                    {/* File Inputs */}
                    <div className="form-group">
                      <label>
                    ...
                    <div>
                      <h2 className="heading-primary2 butler-regular">E-Signature</h2>
                      <p className="heading-para gorditas-regular">
                        <strong>Note:</strong> I hereby declare that the information
                        provided is true and complete to the best of my knowledge and
                        belief. If any information is found to be suppressed,
                        misrepresented, or false, I accept responsibility for the
                        consequences and understand that I may be subject to disciplinary
                        action.
                      </p>
                    </div>
