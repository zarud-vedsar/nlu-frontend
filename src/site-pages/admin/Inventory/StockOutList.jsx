...
function ProductList() {
    ...
    const fetchList = async () => {
        ...
        setIsSubmit(true);
        try {
            const response = await dataFetchingPost(`${NODE_API_URL}/api/inventory/stock/out/list`,
                {
                                        ...
                                        <Column
                                            ...
                                            body={(rowData) => (
                                                <div className="d-flex">
                                                    <Link to={`/admin/inventory/product/add-stockout/${rowData.id}`} className="avatar avatar-icon avatar-md avatar-orange">
