    ...
    setLoader(true);
      ...
      try {
        ...
        if (response.data?.status === 200 || response.data?.status === 201) {
          ...
          toast.error(response.data?.msg || "Failed to generate attendace marks.");
        }
      } catch (error) {
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-3 col-lg-3 col-12 mb-2">
                              ...
                              <input
                                ...
                                className="form-control"
                                value={
                                  marksData[rowData.stid]?.attendance || ""
                                }
                                onChange={(e) =>
                                  handleInputChange(
                                    rowData.stid,
                            ...
                            <div className="col-md-3 col-lg-3 col-12 mb-2">
                              ...
                              <input
                                type="number"
                                className="form-control"
                                value={marksData[rowData.stid]?.max_end || ""}
                                onChange={(e) =>
                                  handleInputChange(
                                    rowData.stid,
                                    "max_end",
                            ...
                            <div className="col-md-3 col-lg-3 col-12 mb-2">
                              <label>Total:</label>
                              <span>
                                {marksData[rowData.stid]?.grand_total || ""}
                              </span>
                            </div>
                            <div className="col-md-3 col-lg-3 col-12 mb-2">
                              <button
